...
% Masa 21/02/2024
function [ap_file,lf_file] = findImecMetaFile(EPHYS_DATAPATH,probe_id,gFileNum,varargin)
if ~isempty(varargin)
    td = dir(fullfile(EPHYS_DATAPATH,sprintf('*%i_g%i*imec%i*.meta',varargin{1},gFileNum,probe_id)));
else
