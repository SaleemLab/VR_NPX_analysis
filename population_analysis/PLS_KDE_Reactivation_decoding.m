...
n_residual = n - mean(n,2); % Mean centered 
...
n_ripples_residuals = n_ripples-mean(n_ripples,2); % mean centered Residuals
...
if isempty(fieldnames(PLS))
    ...
    % Combine data and labels
    X = [n_residual(T1_bins,:); n_residual(T2_bins,:)];
    ...
    for fold = 1:numFolds
        ...
        [W, ~] = qr(XL, 0); % Orthonormalize XL using QR decomposition
        plsScores_Track1 = n_residual(testIdx & Y == 1,:) * W;
        plsScores_Track2 = n_residual(testIdx & Y == 2,:) * W;
...
if plot_option == 1
    ...
    subplot(2,2,2)
    scatter3(plsScores_Track2(:, 1), plsScores_Track2(:, 2), plsScores_Track2(:, 3),10,'r','filled','MarkerFaceAlpha',0.02);  hold on;
    scatter3(plsScores_Track1(:, 1), plsScores_Track1(:, 2), plsScores_Track1(:, 3),10,'b','filled','MarkerFaceAlpha',0.02);hold on;
    plsScores_ripples = n_ripples * W;
    scatter3(plsScores_ripples(:, 1), plsScores_ripples(:, 2), plsScores_ripples(:, 3),10,'m','filled','MarkerFaceAlpha',0.05);  hold on;
...
% figure
% X_residual = X;
% % plsScores_Track1 = X_residual(Y == 1,:) * W;
% % plsScores_Track2 = X_residual(Y == 2,:) * W;
% % scatter3(plsScores_Track2(:, 1), plsScores_Track2(:, 2), plsScores_Track2(:, 3),10,'b','filled','MarkerFaceAlpha',0.05);  hold on;
% % scatter3(plsScores_Track1(:, 1), plsScores_Track1(:, 2), plsScores_Track1(:, 3),10,'r','filled','MarkerFaceAlpha',0.05);hold on;
% 
% plsScores_Track1 = X_residual(Y == 1,:) * stats.W;
% plsScores_Track2 = X_residual(Y == 2,:) * stats.W;
% scatter3(plsScores_Track2(:, 1), plsScores_Track2(:, 2), plsScores_Track2(:, 3),10,'b','filled','MarkerFaceAlpha',0.05);  hold on;
% scatter3(plsScores_Track1(:, 1), plsScores_Track1(:, 2), plsScores_Track1(:, 3),10,'r','filled','MarkerFaceAlpha',0.05);hold on;
% 
% % 
% % scatter3(n_ripples(45000:50000,:)* W(:,1), n_ripples(45000:50000,:)* W(:,2), n_ripples(45000:50000,:)* W(:,3),10,'k','filled','MarkerFaceAlpha',0.1);hold on;
% % scatter3(n_ripples_residuals(45000:50000,:)* W(:,1), n_ripples_residuals(45000:50000,:)* W(:,2), n_ripples_residuals(45000:50000,:)* W(:,3),10,'k','filled','MarkerFaceAlpha',0.1);hold on;
% 
% scatter3(n_ripples_residuals(45000:50000,:)* stats.W(:,1), n_ripples_residuals(45000:50000,:)* stats.W(:,2), n_ripples_residuals(45000:50000,:)* stats.W(:,3),10,'k','filled','MarkerFaceAlpha',0.1);hold on;
% % scatter3(n_ripples(45000:50000,:)* stats.W(:,1), n_ripples(45000:50000,:)* stats.W(:,2), n_ripples(45000:50000,:)* stats.W(:,3),10,'k','filled','MarkerFaceAlpha',0.1);hold on;
% 
