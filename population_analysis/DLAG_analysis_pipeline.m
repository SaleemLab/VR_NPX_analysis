function [estParams,trackedParams,flags] = DLAG_analysis_pipeline(seqTrue,binWidth,yDims,options)
...
parallelize = true;
numWorkers = maxNumCompThreads;      % Adjust this to your computer's specs
