...
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','ripple_MUA_PSTH_all_POST_spindle_power_ripple_power_300ms_interval.mat'),'V1_PSTH_spindle_power','V1_PSTH_ripple_power','V1_PSTH_SO',...
    'HPC_PSTH_spindle_power','HPC_PSTH_ripple_power','HPC_PSTH_SO','-v7.3')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','ripple_MUA_PSTH_all_POST_spindle_power_ripple_power_300ms_interval.mat'),'HPC_PSTH_SO','V1_PSTH_SO')


save(fullfile(analysis_folder,'V1-HPC sleep reactivation','ripple_MUA_PSTH_all_POST_ripple_spindle_SO_300ms_interval.mat'),'V1_PSTH_spindle_power','V1_PSTH_ripple_power','V1_PSTH_SO',...
    'HPC_PSTH_spindle_power','HPC_PSTH_ripple_power','HPC_PSTH_SO','-v7.3')
