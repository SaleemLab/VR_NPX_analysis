...
for nsession = 1:length(sessions_to_process)
    ...
    for hemi = 1:2
        ...
        remove_id = find(diff(event_times)<0.1)+1;
...
save(fullfile(analysis_folder,'ripple_V1_MUA_PSTH_all_POST.mat'),'ripple_V1_MUA_PSTH_all','ripple_V1_MSUA_PSTH_all','-v7.3')
...
%     temp_PSTH(1,nsession,:) = mean([squeeze(temp_PSTH1(1,nsession,:)) squeeze(temp_PSTH2(2,nsession,:))],2);
%     temp_PSTH(2,nsession,:) = mean([squeeze(temp_PSTH1(2,nsession,:)) squeeze(temp_PSTH2(1,nsession,:))],2);
    temp_PSTH(1,nsession,:) = mean([squeeze(temp_PSTH1(1,nsession,:)) squeeze(temp_PSTH2(1,nsession,:))],2);
    temp_PSTH(2,nsession,:) = mean([squeeze(temp_PSTH1(2,nsession,:)) squeeze(temp_PSTH2(2,nsession,:))],2);
