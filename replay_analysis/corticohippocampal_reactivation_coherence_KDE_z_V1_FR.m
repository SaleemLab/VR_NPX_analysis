...
nfig = figure;
nfig.Name = 'KDE Bias z V1 PSTH Track 1 vs Track 2 All'; 
...
nfig = figure;
nfig.Name = 'KDE Bias z V1 FR PSTH Track 1 vs Track 2 High ripple power'; 
nfig.Position = [500 75 700 850];
...
% T1 events: keep those coupled to spindle peak in hemisphere 2
T1_events = intersect(T1_events, find(is_peak_phase_2+is_peak_phase_1>0));

% T2 events: keep those coupled to spindle peak in hemisphere 1
T2_events = intersect(T2_events, find(is_peak_phase_2+is_peak_phase_1>0));
...
% T1 events: keep those coupled to spindle peak in hemisphere 2
T1_events = intersect(T1_events, find(is_trough_phase_2+is_trough_phase_1>0));

% T2 events: keep those coupled to spindle peak in hemisphere 1
T2_events = intersect(T2_events, find(is_trough_phase_1+is_trough_phase_1>0));
