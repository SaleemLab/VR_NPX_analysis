...
save(fullfile(analysis_folder,'V1-HPC bilateral interaction','survival analysis','last_ripple_power_survival.mat'),'output');
save_all_figures(fullfile(analysis_folder,'V1-HPC bilateral interaction','survival analysis'),[])


output = plot_UP_survival_probability( ...
    {UP_DOWN_info.ipsi_last_ripple_HPC_MUA_peak_UP, UP_DOWN_info.contra_last_ripple_HPC_MUA_peak_UP}, ...
    {UP_DOWN_info.ipsi_time_from_last_ripples_UP, UP_DOWN_info.contra_time_from_last_ripples_UP}, ...
    {UP_DOWN_info.ipsi_ripple_counts_UP, UP_DOWN_info.contra_ripple_counts_UP},'count_option',[], ...
    'event_option',[],'title_name', 'Last ripple HPC MUA peak and last ripple to UP-DOWN transition','subject_id',subject_id...
);
save(fullfile(analysis_folder,'V1-HPC bilateral interaction','survival analysis','last_ripple_power_survival.mat'),'output');
save_all_figures(fullfile(analysis_folder,'V1-HPC bilateral interaction','survival analysis'),[])
...
% output = plot_UP_survival_probability( ...
%     {UP_DOWN_info.ipsi_last_ripples_duration_UP, UP_DOWN_info.contra_last_ripples_duration_UP}, ...
%     {UP_DOWN_info.ipsi_time_from_last_ripples_UP, UP_DOWN_info.contra_time_from_last_ripples_UP}, ...
%     {UP_DOWN_info.ipsi_ripple_counts_UP, UP_DOWN_info.contra_ripple_counts_UP},'count_option',[], ...
...
% cumulative ripple HPC MUA predicts UP probability
plot_UP_survival_probability( ...
    {nanmean([UP_DOWN_info.ipsi_normalised_ripple_HPC_MUA_cumulative_UP; UP_DOWN_info.contra_normalised_ripple_HPC_MUA_cumulative_UP])'}, ...
    {UP_DOWN_info.ipsi_time_from_last_ripples_UP}, ...
    {UP_DOWN_info.ipsi_ripple_counts_UP},'count_option',[],'subject_id',subject_id, ...
...
save(fullfile(analysis_folder,'V1-HPC bilateral interaction','survival analysis','HPC_MUA_2nd_1st_survival.mat'),'output');
...
save(fullfile(analysis_folder,'V1-HPC bilateral interaction','survival analysis','V1_MUA_2nd_1st_survival.mat'),'output');
save_all_figures(fullfile(analysis_folder,'V1-HPC bilateral interaction','survival analysis'),[])
