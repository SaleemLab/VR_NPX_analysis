function plot_V1_events_spiketimes(spike_times,spike_id,Task_info,Behaviour,subplot_xy,window,psthBinSize,varargin)
...
% 
        ...
        if iCluster == no_subplot
            ...
            legend([h(1:2)],{'Track Left V1 events','Track Right V1 events'},'Color','none')
        end
        xlim(window)
        xlabel('Time')
        ylabel('FR')
