...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 All (PRE-ripple) based on V1 bias'; 
nfig.Position = [500 75 700 850];

event_index = [T1_events T2_events];
z_event = nanmean(z_bias_V1(bins_to_use,[T1_events T2_events]));
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 All based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 Low ripple power based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 High ripple power based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with low spindle power based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with high spindle power based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with low spindle power (PRE-ripple) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with high spindle power (PRE-ripple) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with spindle phase peak based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
MUA_bin_centers = []
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with spindle phase trough based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with spindle phase peak (PRE-ripple) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
MUA_bin_centers = []
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with spindle phase trough (PRE-ripple) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with SO phase peak based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with SO phase trough based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with SO phase peak (PRE-ripple) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with SO phase trough (PRE-ripple) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with low delta power based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with high delta power based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with low delta power (PRE-ripples) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with high delta power (PRE-ripples) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
T1_events = intersect(T1_events,find(SO_index1));
T2_events = intersect(T2_events,find(SO_index2));
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with low delta power in opposite V1 based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with high delta power in opposite V1 based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with low delta power in opposite V1 (PRE-ripples) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with high delta power in opposite V1 (PRE-ripples) based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
SO_index1 = ripple_info.UP_index(:,1)==1;
SO_index2 = ripple_info.UP_index(:,2)==1;
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with UP based on V1 bias'; 
nfig.Position = [500 75 700 850];
...
SO_index1 = ripple_info.DOWN_index(:,1)==1;
SO_index2 = ripple_info.DOWN_index(:,2)==1;
...
nfig = figure;
nfig.Name = 'KDE Bias PSTH Track 1 vs Track 2 with DOWN based on V1 bias'; 
nfig.Position = [500 75 700 850];
