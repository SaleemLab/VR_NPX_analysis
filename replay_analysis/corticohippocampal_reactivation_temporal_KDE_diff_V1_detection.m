...
for nprobe = 1:2
    temp =  merged_event_info.UP_hemisphere_id==nprobe;
    ...
    [~,UP_index,~,index] = RestrictInts(merged_event_info.ripples_ints,[merged_event_info.UP_ints(temp,2)-0.25 merged_event_info.UP_ints(temp,2)]);
