...
save('all_ripples_KDE_bias_difference.mat', 'all_ripples_res');
...
% Save calculation results
save('all_ripples_KDE_bias_difference_PRE.mat', 'all_ripples_res');
...
% 
% load('ripple_power_KDE_bias_difference.mat', 'ripple_power_KDE_bias_difference');
...
% Save results
save('ripple_power_KDE_bias_difference_PRE.mat', 'ripple_power_KDE_bias_difference');
% 
...
fig = figure;
fig.Position = [640 100 2*1100/3 650/2]
fig.Name = 'KDE bias difference in V1 low vs high ripples (100ms example)';
% tiledlayout(nBins, 3, 'TileSpacing', 'compact');
% colour_lines = [158,202,225;33,113,181]/256;% two blue
nexttile
for npower = [1 4]
