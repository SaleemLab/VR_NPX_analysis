...
% z_bias_KDE = KDE_reactivation_ripples_PSTH.HPC_z_ripples';
% z_bias_V1_KDE = KDE_reactivation_ripples_PSTH.V1_z_ripples';

% z_bias_KDE = KDE_reactivation_ripples_PSTH.HPC_z_logodds_ripples' + KDE_reactivation_ripples_PSTH.nan_mask';
% z_bias_V1 = KDE_reactivation_ripples_PSTH.V1_z_logodds_ripples' + KDE_reactivation_ripples_PSTH.nan_mask';
% z_bias_V1 = z_bias_V1(1:2:end,:);

z_bias = KDE_reactivation_ripples_PSTH.HPC_z_logodds_ripples' + KDE_reactivation_ripples_PSTH.nan_mask';
z_bias = z_bias(1:2:end,:);
...
% A = reshape(z_bias,1,[]);
% B = reshape(z_bias_KDE(1:2:end,:),1,[]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for t = 1:nTime
    ...
    for npower = 1:nBins
        ...
        if sum(bins_to_select)>1
            mean_bias_V1 = mean(z_bias_V1(bins_to_select, event_index), 'omitnan'); % V1 sliding
        else
            mean_bias_V1 = z_bias_V1(bins_to_select, event_index); % V1 sliding
        end
...
% save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_phase.mat'),'AUC')
% load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_phase.mat'))
for npower = 1:nBins
    nexttile; hold on;
    m  = AUC.mean(:,npower);
...
% Save results
save_all_figures(fullfile(analysis_folder,'V1-HPC sleep reactivation','temporal Bayesian bias difference'),[])
...
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_peak_synchony.mat'),'AUC')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_peak_synchony.mat'))
for npower = 1:nBins
    nexttile; hold on;
    m  = AUC.mean(:,npower);
    ci = squeeze(AUC.ci(~isnan(m),npower,:));
...
% save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_trough_synchony.mat'),'AUC')
% load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_trough_synchony.mat'))
for npower = 1:nBins
    nexttile; hold on;
    m  = AUC.mean(:,npower);
    ci = squeeze(AUC.ci(~isnan(m),npower,:));
...
% load
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_spindle_trough_synchony.mat'),'AUC')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_spindle_trough_synchony.mat'))
...
% load
% -------- Plot --------
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_trough_spindle_power.mat'),'AUC')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_trough_spindle_power.mat'))
...
% load
% -------- Plot --------
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_peak_spindle_power.mat'),'AUC')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_peak_spindle_power.mat'))
...
% load
% -------- Plot --------
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_peak_SO_power.mat'),'AUC')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_peak_SO_power.mat'))
...
% load
% -------- Plot --------
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_trough_SO_power.mat'),'AUC')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_SO_trough_SO_power.mat'))
...
% -------- save --------
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_normalised_UP_duration.mat'),'AUC')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_normalised_UP_duration.mat'))
...
% -------- save --------
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_DU_UD_250ms.mat'),'AUC')
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_DU_UD_250ms.mat'))
