...
fig = figure('Name','Temporal V1 Bayesian log-odds AUC different ripple powers','Position',[640 100 1100/3 900]);
...
save(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_ripple_power.mat'),'AUC')
...
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','Bayesian_temporal_bias_ripple_power.mat'),'AUC')


% Plot temporal AUC traces
fig = figure('Name','Temporal V1 Bayesian log-odds AUC low vs high ripple powers','Position',[640 100 1100/3 900/4]);
tiledlayout(nBins, 1, 'TileSpacing','compact');
