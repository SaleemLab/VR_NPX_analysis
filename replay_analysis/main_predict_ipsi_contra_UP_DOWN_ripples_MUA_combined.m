...
tbl = table(...
    ...
    UP_DOWN_info.SWpeakmag_DU(:), ...                                % Added DU_delta
    UP_DOWN_info.SWpeakmag_UD(:), ...                                % Added UD_delta
    ...
    'DU_delta', 'UD_delta', 'RippleCounts', ...         % Renamed to 'RippleCounts'
    'AnimalID', 'SessionID'});
...
tbl_temp=tbl;
lme2 = fitlme(tbl_temp, 'earlyUPV1 ~  lastRippleHPC + firstRippleHPC + (1|AnimalID) + (1|SessionID)');
lme2.Coefficients
