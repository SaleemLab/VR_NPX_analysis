...
load(fullfile(analysis_folder,'V1-HPC sleep reactivation','UP_DOWN_info_100ms.mat'),'UP_DOWN_info');s
load(fullfile(analysis_folder,'slow_waves_all_POST.mat'))
load(fullfile(analysis_folder,'V1-HPC sleep interaction','merged_UP_DOWN_ripples_event_info.mat'),'merged_event_info');
...
UD_lags = nan(length(UP_DOWN_info.ripple_counts_UP),1);
UD_lags(merged_event_info.DOWN_overlap_idx_all{end}) = abs(merged_event_info.DOWN_lags_all{end});

DU_lags = nan(length(UP_DOWN_info.ripple_counts_UP),1);
