...
fig.Name = 'KDE bias difference in HPC with different moving spindle powers';
...
fig.Name = 'KDE bias difference in HPC low vs high moving spindle power';
...
fig = figure;
fig.Position = [640 100 1100 650*2];
fig.Name = 'KDE bias difference in HPC with different moving spindle powers (PRE ripple)';
tiledlayout(nBins, 3, 'TileSpacing', 'compact');
