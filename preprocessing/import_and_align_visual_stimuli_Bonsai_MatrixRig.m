...
%   
function   [behaviour,task_info,peripherals] = import_and_align_visual_stimuli_Bonsai_MatrixRig(StimulusName,options)
...
if isfield(options,'bonsai_files_names')
    ...
    TRIALDATA_DATAPATH = char(fullfile(options.BONSAI_DATAPATH,options.bonsai_files_names(contains(options.bonsai_files_names,'Photodiode'))));
