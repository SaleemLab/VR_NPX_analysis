function probability = calculate_UP_DOWN_ripple_PSTH(slow_waves_all,ripples_all,behavioural_state_merged_all,sessions_to_process,varargin)
...
for nprobe = 1:length(slow_waves_all)
    ...
    for nsession = 1:length(sessions_to_process)
        ...
        if contains(time_option,'normalised')
