...
T_last_ripple.last_ripple_V1_MUA_gain = T_last_ripple.last_ripple_V1_MUA_mean./T_last_ripple.past_ripples_V1_MUA_mean;
T_last_ripple.last_ripple_V1_MUA_gain_baseline = T_last_ripple.last_ripple_V1_MUA_mean./T_last_ripple.non_ripple_V1_MUA_mean;
T_last_ripple.past_ripples_V1_MUA_gain_baseline = T_last_ripple.past_ripples_V1_MUA_mean./T_last_ripple.non_ripple_V1_MUA_mean;
% T_last_ripple.last_ripple_HPC_MUA_gain = T_last_ripple.last_ripple_HPC_MUA_sum./T_last_ripple.past_ripples_HPC_MUA_sum;
% T_last_ripple.last_ripple_HPC_MUA_gain_baseline = T_last_ripple.last_ripple_HPC_MUA_sum./T_last_ripple.non_ripple_HPC_MUA_sum;
% T_last_ripple.past_ripples_HPC_MUA_gain_baseline = T_last_ripple.past_ripples_HPC_MUA_sum./T_last_ripple.non_ripple_HPC_MUA_sum;

T_last_ripple.last_ripple_V1_MUA_gain(isinf(T_last_ripple.last_ripple_V1_MUA_gain))=nan;
T_last_ripple.last_ripple_V1_MUA_gain_baseline(isinf(T_last_ripple.last_ripple_V1_MUA_gain_baseline))=nan;
T_last_ripple.past_ripples_V1_MUA_gain_baseline(isinf(T_last_ripple.past_ripples_V1_MUA_gain_baseline))=nan;

T_last_ripple.last_ripple_V1_MUA_gain(T_last_ripple.last_ripple_V1_MUA_gain>prctile(T_last_ripple.last_ripple_V1_MUA_gain,99.5))=prctile(T_last_ripple.last_ripple_V1_MUA_gain,99.5);
T_last_ripple.last_ripple_V1_MUA_gain_baseline(T_last_ripple.last_ripple_V1_MUA_gain_baseline>prctile(T_last_ripple.last_ripple_V1_MUA_gain_baseline,99.5))=prctile(T_last_ripple.last_ripple_V1_MUA_gain_baseline,99.5);
T_last_ripple.past_ripples_V1_MUA_gain_baseline(T_last_ripple.past_ripples_V1_MUA_gain_baseline>prctile(T_last_ripple.past_ripples_V1_MUA_gain_baseline,99.5))=prctile(T_last_ripple.past_ripples_V1_MUA_gain_baseline,99.5);




% 
% T_last_ripple.last_past_ripple_HPC_MUA_diff = T_last_ripple.last_ripple_HPC_MUA_mean-T_last_ripple.past_ripples_HPC_MUA_mean;
% T_last_ripple.last_ripple_non_ripple_HPC_MUA_diff = T_last_ripple.last_ripple_HPC_MUA_mean-T_last_ripple.non_ripple_HPC_MUA_mean;
% T_last_ripple.past_ripples_non_ripple_HPC_MUA_diff = T_last_ripple.past_ripples_HPC_MUA_mean-T_last_ripple.non_ripple_HPC_MUA_mean;
...
% % T_last_ripple.
% 
% model_covariates = {'last_ripple_HPC_MUA_mean','last_ripple_HPC_MUA_sum','last_ripple_power','last_ripple_duration','last_ripple_non_ripple_HPC_MUA_diff'};
% model_labels     = {'Last Ripple HPC MUA mean','Last Ripple HPC MUA sum','last ripple power','last ripple duration','past ripple HPC MUA gain'};
% 
% T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
% plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
%     'title_name', 'UP Survival analysis', ...
%     'feature_labels', model_labels, ...
%     'strata_var', 'session_id', ...
%     'plot_ecdf',true, ...
%     'plot_bar',false);
% 
% output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
%     'title_name', 'Last ripple effect on UP survival (univariate)', ...
...
%     'title_name', 'Last ripple effect on UP survival', ...
%     'feature_labels', model_labels, ...
%     'strata_var', 'session_id', ...
%     'plot_ecdf',false, ...
%     'plot_bar',true);
...
%% Model 1 Last ripple features
% 
% model_covariates = {'last_ripple_HPC_MUA_mean','last_ripple_HPC_MUA_sum','last_ripple_power','last_ripple_duration','last_ripple_non_ripple_HPC_MUA_diff'};
% model_labels     = {'Last Ripple HPC MUA mean','Last Ripple HPC MUA sum','last ripple power','last ripple duration','last ripple non ripple HPC MUA diff'};

model_covariates = {'last_ripple_HPC_MUA_mean','last_ripple_HPC_MUA_sum','last_ripple_power','last_ripple_duration','last_ripple_HPC_MUA_gain_baseline'};
model_labels     = {'Last Ripple HPC MUA mean','Last Ripple HPC MUA sum','last ripple power','last ripple duration','last ripple baseline HPC MUA ratio'};

% model_covariates = {'last_ripple_HPC_MUA_mean','last_ripple_HPC_MUA_sum'};
% model_labels     = {'Last Ripple HPC MUA mean','Last Ripple HPC MUA sum'};
...
save(fullfile(output_dir, 'model_last_ripple_feature.mat'), 'output_model','output_model_univariate');


T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Last ripple effect on UP survival (univariate) (multiripple UP)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Last ripple effect on UP survival (multiripple UP)', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
save(fullfile(output_dir, 'model_last_ripple_feature_multiripple_UP.mat'), 'output_model','output_model_univariate');
save_all_figures(output_dir, []);

% 
% figure;scatter(T_last_ripple.last_ripple_HPC_MUA_sum,T_last_ripple.last_ripple_duration);
% figure;scatter(T_last_ripple.last_ripple_non_ripple_HPC_MUA_diff,T_last_ripple.last_ripple_power);


x = T_last_ripple.last_ripple_non_ripple_HPC_MUA_diff;
y = T_last_ripple.last_ripple_HPC_MUA_mean;
z = T_last_ripple.last_ripple_power;
% plot_2D_scatter(x, y,'z', z, ...
%     'xlabel_text', 'Last Ripple HPC MUA normalised rate relative to baseline', ...
%     'ylabel_text', 'Last Ripple power (z)', ...
%     'clabel_text', 'Last Ripple HPC MUA normalised rate (s)', ...
%     'animal_id', T_last_ripple.subject_id, ...       % Vector or cell array of animal IDs
%     'session_id', T_last_ripple.session_id, ...     % Vector or cell array of session IDs
...
x = log(T_last_ripple.last_ripple_HPC_MUA_gain_baseline);

% x = T_last_ripple.last_ripple_HPC_MUA_gain_baseline;
y = log(T_last_ripple.last_ripple_power);
% z = T_last_ripple.last_ripple_HPC_MUA_mean;
% plot_2D_scatter(x, y, ...
%     'title_name','Last ripple MUA rate relative to baseline vs ripple power',...
%     'xlabel_text', 'Last Ripple HPC MUA normalised rate relative to baseline', ...
%     'ylabel_text', 'Last Ripple power (z)', ...
%     'animal_id', T_last_ripple.subject_id, ...       % Vector or cell array of animal IDs
%     'session_id', T_last_ripple.session_id, ...     % Vector or cell array of session IDs
...
% 
x = T_last_ripple.last_ripple_HPC_MUA_gain_baseline;
y = T_last_ripple.last_ripple_power;
...
%% Model 2 past ripples MUA rate vs last ripple MUA rate 

T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);

model_covariates = {'last_ripple_HPC_MUA_mean', ...
                     'past_ripples_HPC_MUA_mean', ...
                     'non_ripple_HPC_MUA_mean'};

model_labels     = {'Last Ripple HPC MUA rate', ...
                     'Past Ripples HPC MUA rate', ...
                     'Non-Ripple HPC MUA rate'};

% T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
output_model2_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past ripple vs last ripple MUA rate on UP Survival (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model2 = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
...
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past ripple vs last ripple MUA rate on UP Survival (UP to last ripple accounted) (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
save(fullfile(output_dir, 'model_past_ripple_vs_last_ripple_MUA_rate.mat'), 'output_model','output_model_univariate','output_model2_univariate','output_model2');
save_all_figures(output_dir, []);
...
% 
% output_model2 = plot_last_ripple_UP_survival(T_last_ripple1, model4_covariates, ...
%     'title_name', 'Past ripple (by bins) vs last ripple MUA rate on UP Survival', ...
%     'feature_labels', model4_labels, ...
%     'strata_var', 'session_id');
% 
% 
% 
% figure;scatter(T_last_ripple.last_ripple_HPC_MUA_mean,T_last_ripple.past_ripples_0_100ms_HPC_MUA_mean);
% 
% figure;scatter(T_last_ripple.last_ripple_HPC_MUA_sum,T_last_ripple.past_ripples_0_100ms_HPC_MUA_sum);
...
model_covariates = {'last_ripple_HPC_MUA_sum', ...
                     'past_ripples_HPC_MUA_sum', ...
                     'non_ripple_HPC_MUA_sum'};

model_labels     = {'Last Ripple HPC MUA sum', ...
                     'Past Ripples HPC MUA sum', ...
                     'Non-Ripple HPC MUA sum'};

% T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
output_model2_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past ripple vs last ripple MUA sum on UP Survival (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model2 = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past ripple vs last ripple MUA sum on UP Survival', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
...
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past ripple vs last ripple MUA sum on UP Survival (UP to last ripple accounted) (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past ripple vs last ripple MUA sum on UP Survival (UP to last ripple accounted)', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
...
save(fullfile(output_dir, 'model_past_ripple_vs_last_ripple_MUA_sum.mat'), 'output_model','output_model_univariate','output_model2_univariate','output_model2');
save_all_figures(output_dir, []);



figure;scatter(T_last_ripple.last_ripple_HPC_MUA_sum,T_last_ripple.past_ripples_HPC_MUA_sum);




%% past ripples sum vs non ripple sum influence on UP termination
% T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);

T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);

model_covariates = {'past_ripples_HPC_MUA_sum', ...
                     'non_ripple_HPC_MUA_sum'};

model_labels     = {'Past Ripples HPC MUA sum', ...
                     'Non-Ripple HPC MUA sum'};

% T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
output_model2_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past ripple vs non ripple MUA sum on UP Survival (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model2 = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past ripple vs non ripple MUA sum on UP Survival', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
...
save(fullfile(output_dir, 'model_past_ripple_vs_non_ripple_MUA_sum.mat'), 'output_model','output_model_univariate','output_model2_univariate','output_model2');
save_all_figures(output_dir, []);



%% Weighted Recency effect
% 
...
model_covariates = {'last_ripple_HPC_MUA_sum','recency_weighted_past_HPC_MUA_sum','non_ripple_HPC_MUA_sum','UP_to_last_ripple'};
model_labels     = {'Last Ripple HPC MUA sum','Recency weighted past HPC MUA','Non ripple past HPC MUA','UP to last ripple duration'};
...
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past Ripples History with recency effect on UP Survival (UP to last ripple duration accounted) (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Past Ripples History with recency effect on UP Survival (UP to last ripple duration accounted)', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
...
save(fullfile(output_dir, 'model_weighted_recency_effect.mat'), 'output_model','output_model_univariate');
save_all_figures(output_dir, []);


% figure;scatter(T_last_ripple.recency_weighted_past_HPC_MUA_sum,T_last_ripple.past_ripples_HPC_MUA_sum);

% 
%% last ripple MUA gain

T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);
model_covariates = {'last_ripple_HPC_MUA_gain_baseline','past_ripples_HPC_MUA_gain_baseline',...
    'UP_to_last_ripple'};
% 
% model4_covariates = {'last_ripple_non_ripple_HPC_MUA_diff','past_ripples_non_ripple_HPC_MUA_diff',...
%     'UP_to_last_ripple'};

model_labels     = {'Last Ripple relative to non ripple MUA rate','Past Ripple relative to non ripple MUA rate', ...
                     'UP to last ripple duration'};
...
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Ripple MUA and past ripples relative to baseline on UP Survival (UP to last ripple accounted) (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Ripple MUA and past ripples relative to baseline on UP Survival (UP to last ripple accounted)', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
...
save(fullfile(output_dir, 'model_last_past_ripples_MUA_rate_ratio.mat'), 'output_model','output_model_univariate');
save_all_figures(output_dir, []);
...
T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);
model_covariates = {'last_ripple_HPC_MUA_gain_baseline','last_ripple_HPC_MUA_gain',...
    'UP_to_last_ripple'};

model_labels     = {'Last Ripple relative to non ripple MUA rate','Last Ripple relative to past ripples MUA rate', ...
                     'UP to last ripple duration'};

% model_covariates = {'last_ripple_HPC_MUA_gain'};
% model_labels     = {'Last Ripple relative to past ripples MUA rate'};
...
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'Ripple MUA relative to baseline and past ripples on UP Survival (UP to last ripple accounted) (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
save(fullfile(output_dir, 'model_last_past_MUA_rate_ratio.mat'), 'output_model','output_model_univariate');
save_all_figures(output_dir, []);



% 
% x = T_last_ripple1.past_ripples_HPC_MUA_mean;
% y = T_last_ripple1.UP_to_last_ripple;
% 
% plot_2D_scatter(x, y, ...
%     'title_name','past ripple relative to baseline VS UP to last ripple time',...
%     'xlabel_text', 'past Ripple HPC MUA normalised rate relative to baseline', ...
%     'ylabel_text', 'Up to last ripple time (s)', ...
%     'animal_id', T_last_ripple1.subject_id, ...       % Vector or cell array of animal IDs
%     'session_id', T_last_ripple1.session_id, ...     % Vector or cell array of session IDs
%     'use_mixed_effects', true, ...     % Enable LME model for stats
%     'title_text', 'Density Scatter', ...
%     'show_stats', true, ...
%     'add_fit_line', true, ...
...
%% last ripple MUA diff
% T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
% % model4_covariates = {'last_ripple_non_ripple_HPC_MUA_diff','last_ripple_HPC_MUA_gain_baseline','last_ripple_HPC_MUA_mean',...
% %     'UP_to_last_ripple'};
% % model4_labels     = {'Last Ripple non ripple MUA rate diff','Last Ripple non ripple MUA rate ratio','Last Ripple HPC MUA rate',...
% %                      'UP to last ripple duration'};
% model4_covariates = {'last_ripple_non_ripple_HPC_MUA_diff','last_ripple_HPC_MUA_gain_baseline','last_ripple_HPC_MUA_mean',...
%     'UP_to_last_ripple'};
% model4_labels     = {'Last Ripple non ripple MUA rate diff','Last Ripple non ripple MUA rate ratio','Last Ripple HPC MUA rate',...
%                      'UP to last ripple duration'};
% output_model = plot_last_ripple_UP_survival(T_last_ripple1, model4_covariates, ...
%     'title_name', 'Ripple MUA relative to baseline effect on UP Survival (UP to last ripple accounted)', ...
%     'feature_labels', model4_labels, ...
%     'strata_var', 'session_id');
% 
% figure;scatter(T_last_ripple.last_ripple_non_ripple_HPC_MUA_diff,T_last_ripple.last_ripple_HPC_MUA_gain_baseline);
% 
% 
% % 
% % T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
% % model4_covariates = {'last_ripple_non_ripple_HPC_MUA_diff','last_ripple_HPC_MUA_gain_baseline',...
% %     'UP_to_last_ripple'};
% % model4_labels     = {'Last Ripple non ripple MUA rate diff','Last Ripple non ripple MUA rate ratio',...
% %                      'UP to last ripple duration'};
% % 
% % output_model = plot_last_ripple_UP_survival(T_last_ripple1, model4_covariates, ...
% %     'title_name', 'Ripple MUA relative to baseline effect on UP Survival (UP to last ripple accounted)', ...
...
% 
% T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);
% model4_covariates = {'last_ripple_non_ripple_HPC_MUA_diff','last_past_ripple_HPC_MUA_diff',...
%     'UP_to_last_ripple'};
% model4_labels     = {'Last Ripple non ripple MUA rate diff','Last Ripple past ripples MUA rate diff',...
%                      'UP to last ripple duration'};
% 
% output_model = plot_last_ripple_UP_survival(T_last_ripple1, model4_covariates, ...
%     'title_name', 'Ripple MUA and baseline and past ripples diff effect on UP Survival (UP to last ripple accounted)', ...
%     'feature_labels', model4_labels, ...
%     'strata_var', 'session_id');
% 
% 
% 
% T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
% model4_covariates = {'past_ripples_HPC_MUA_mean','past_ripples_non_ripple_HPC_MUA_diff',...
%     'UP_to_last_ripple'};
% model4_labels     = {'Past ripples MUA rate','Past Ripples non ripple MUA rate diff' ...
%                      'UP to last ripple duration'};
% output_model2 = plot_last_ripple_UP_survival(T_last_ripple1, model4_covariates, ...
%     'title_name', 'Past ripples relative baseline on UP Survival', ...
%     'feature_labels', model4_labels, ...
%     'strata_var', 'session_id');
% 
% % 
% % T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
% % model4_covariates = {'last_ripple_HPC_MUA_mean','last_ripple_HPC_MUA_gain_baseline','last_ripple_non_ripple_HPC_MUA_diff'};
% % model4_labels     = {'Last Ripple MUA rate','Last Ripple relative to non ripple MUA rate','Last Ripple non ripple MUA rate diff'};
% % 
% % output_model3 = plot_last_ripple_UP_survival(T_last_ripple1, model4_covariates, ...
% %     'title_name', 'Ripple MUA relative to baseline on UP Survival', ...
% %     'feature_labels', model4_labels, ...
...
T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);
% model_covariates = {'last_ripple_HPC_MUA_sum','past_ripples_HPC_MUA_sum','non_ripple_HPC_MUA_sum','last_ripple_HPC_MUA_gain_baseline',...
% 'last_ripple_HPC_MUA_gain','UP_to_last_ripple'};
% model_labels     = {'Last Ripple HPC MUA sum','Past Ripples HPC MUA sum','Non-Ripple HPC MUA sum',...
% 'Last Ripple relative to non ripple MUA rate','Last Ripples relative to past ripples MUA rate','UP to last ripple duration'};


% model_covariates = {'last_ripple_HPC_MUA_sum','past_ripples_HPC_MUA_sum','non_ripple_HPC_MUA_sum','last_ripple_non_ripple_HPC_MUA_diff',...
% 'last_past_ripple_HPC_MUA_diff','UP_to_last_ripple'};
model_covariates = {'last_ripple_HPC_MUA_sum','past_ripples_HPC_MUA_sum','non_ripple_HPC_MUA_sum','last_ripple_HPC_MUA_gain_baseline',...
'last_ripple_HPC_MUA_gain','last_ripple_power','UP_to_last_ripple'};

model_labels     = {'Last Ripple HPC MUA sum','Past Ripples HPC MUA sum','Non-Ripple HPC MUA sum',...
'Last Ripple relative to non ripple MUA rate','Last Ripples relative to past ripples MUA rate','last ripple power','UP to last ripple duration'};

% model_covariates = {'past_ripples_HPC_MUA_sum','non_ripple_HPC_MUA_sum','last_ripple_non_ripple_HPC_MUA_diff',...
% 'last_past_ripple_HPC_MUA_diff','UP_to_last_ripple'};
% 
% model_labels     = {'Past Ripples HPC MUA sum','Non-Ripple HPC MUA sum',...
% 'Last Ripple relative to non ripple MUA rate','Last Ripples relative to past ripples MUA rate','UP to last ripple duration'};
% 

% model_covariates = {'last_ripple_HPC_MUA_sum','past_ripples_HPC_MUA_sum','last_ripple_non_ripple_HPC_MUA_diff',...
% 'last_past_ripple_HPC_MUA_diff','UP_to_last_ripple'};
% model_labels     = {'Last Ripple HPC MUA sum','Past Ripples HPC MUA sum',...
% 'Last Ripple relative to non ripple MUA rate','Last Ripples relative to past ripples MUA rate','UP to last ripple duration'};
...
% 
% model_covariates = {'last_ripple_HPC_MUA_sum','past_ripples_HPC_MUA_sum','non_ripple_HPC_MUA_sum','last_ripple_non_ripple_HPC_MUA_diff',...
% 'last_past_ripple_HPC_MUA_diff','last_ripple_power','UP_to_last_ripple'};
% model_labels     = {'Last Ripple HPC MUA sum','Past Ripples HPC MUA sum','Non-Ripple HPC MUA sum',...
% 'Last Ripple relative to non ripple MUA rate','Last Ripples relative to past ripples MUA rate','last ripple power','UP to last ripple duration'};


model_covariates = {'past_ripples_HPC_MUA_sum','non_ripple_HPC_MUA_sum','last_ripple_HPC_MUA_gain_baseline',...
'last_ripple_HPC_MUA_gain','last_ripple_power','UP_to_last_ripple'};
...
T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'last ripple and past ripples and past non-ripple on UP Survival (UP to last ripple duration accounted) (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'last ripple and past ripples and past non-ripple on UP Survival (UP to last ripple duration accounted)', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
...
save(fullfile(output_dir, 'model_combined.mat'), 'output_model','output_model_univariate');
save_all_figures(output_dir, []);


%% V1 HC MUA
% model_covariates = {'last_ripple_V1_MUA_sum','past_ripples_V1_MUA_sum','non_ripple_V1_MUA_sum','last_ripple_V1_MUA_gain_baseline',...
% 'last_ripple_V1_MUA_gain','last_ripple_power','UP_to_last_ripple'};
% 
% model_labels     = {'Last Ripple V1 MUA sum','Past Ripples V1 MUA sum','Non-Ripple V1 MUA sum',...
% 'Last Ripple relative to non ripple V1 MUA rate','Last Ripples relative to past ripples V1 MUA rate','last ripple power','UP to last ripple duration'};
% 

% 
% model_covariates = {'past_ripples_HPC_MUA_sum','past_ripples_V1_MUA_sum','non_ripple_HPC_MUA_sum','non_ripple_V1_MUA_sum','last_ripple_HPC_MUA_gain_baseline',...
% 'last_ripple_HPC_MUA_gain','last_ripple_power','UP_to_last_ripple'};
% 
% model_labels     = {'Past Ripples HPC MUA sum','Past Ripples V1 MUA sum','Non-Ripple HPC MUA sum','Non-Ripple V1 MUA sum'...
% 'Last Ripple relative to non ripple MUA rate','Last Ripples relative to past ripples MUA rate','last ripple power','UP to last ripple duration'};
% 

model_covariates = {'past_ripples_HPC_MUA_sum','non_ripple_HPC_MUA_sum','non_ripple_V1_MUA_sum','last_ripple_HPC_MUA_gain_baseline',...
'last_ripple_HPC_MUA_gain','last_ripple_power','UP_to_last_ripple'};

model_labels     = {'Past Ripples HPC MUA sum','Non-Ripple HPC MUA sum','Non-Ripple V1 MUA sum'...
'Last Ripple relative to non ripple MUA rate','Last Ripples relative to past ripples MUA rate','last ripple power','UP to last ripple duration'};
...
T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'last ripple and past ripples and past non-ripple HC and V1 on UP Survival (UP to last ripple duration accounted) (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'last ripple and past ripples and past non-ripple HC and V1 on UP Survival (UP to last ripple duration accounted)', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
...
save(fullfile(output_dir, 'HC_V1_model_combined.mat'), 'output_model','output_model_univariate');
save_all_figures(output_dir, []);
...
T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>1,:);
output_model_univariate = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'last ripple and past ripples and past non-ripple V1 on UP Survival (UP to last ripple duration accounted) (univariate)', ...
    'model_type', 'univariable',...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
...
output_model = plot_last_ripple_UP_survival(T_last_ripple1, model_covariates, ...
    'title_name', 'last ripple and past ripples and past non-ripple V1 on UP Survival (UP to last ripple duration accounted)', ...
    'feature_labels', model_labels, ...
    'strata_var', 'session_id', ...
    'plot_ecdf',false, ...
    'plot_bar',true);
...
save(fullfile(output_dir, 'V1_model_combined.mat'), 'output_model','output_model_univariate');
save_all_figures(output_dir, []);
% save(fullfile(output_dir, 'model_combined.mat'), 'output_model');
...
T_last_ripple1 = T_last_ripple(T_last_ripple.ripple_count>0,:);
model4_covariates = {'last_ripple_HPC_MUA_sum','past_ripples_HPC_MUA_sum','non_ripple_HPC_MUA_sum','last_ripple_HPC_MUA_gain_baseline','UP_to_last_ripple'};
