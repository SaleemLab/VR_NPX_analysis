...
%
% New code based on [resps,otherData,stimData,eyeData,wheelData,photodiodeData] = extractAndCollateNPData(options)
% Programe to extract data from Neuropixel and Bonsai/BonVision 
...
%
function [resps,otherData,stimData,eyeData,wheelData,photodiodeData,timeVector,options] = visual_response_analysis(options)
