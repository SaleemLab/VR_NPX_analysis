...
% 2019-10 MM modified for VR recordings

% Analog channel reader. Loads the photodiode, speed, and sync pulse
% signals

function ACInfo = getEPhysAnalogSignals_VR(animal,iseries)
...
%     FoldersList = uigetfile_n_dir(DIRS.multichanspikes,'Select the folder(s) of interest');
    FoldersList = uigetfile_n_dir([DIRS.ePhys filesep iseries],'Select the folder(s) of interest');
