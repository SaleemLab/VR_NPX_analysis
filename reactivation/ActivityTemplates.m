...
% Modified by Masahiro Takigawa 2024
...
% subplot(2,2,2);
% imagesc(controlCorrelations);colorbar

if ~isempty(controlBins)
    correlations = correlations - controlCorrelations;
    correlations=correlations./max(max(correlations));
end
% subplot(2,2,3);imagesc(correlations);colorbar
