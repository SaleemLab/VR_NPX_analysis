    ...
    for n = 1:length(session_info) % How many recording sessions for spatial tasks (PRE, RUN and POST)
        ...
        if (contains(Stimulus_type, 'OMIT') || strcmp(Stimulus_type, 'E_CD')) && contains(plot_choice, 'aggregate') && contains(plot_type, 'FR')
            for nprobe = 1:length(clusters)
                ...
                xline(0.90, 'k', (sprintf('D %d%s onset', round(rad2deg(ordered_oris(4))), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'FontSize', 14);
                ...
                set(gca, "TickDir", "out", 'box', 'off', 'Color', 'none', 'FontSize', 14);
                    ...
                    % Make legend labels
                if strcmp(Stimulus_type, 'OMIT')
                    legend(sprintf('ABCD (%dx)', size(blue_onsets, 2)), sprintf('A_CD (%dx)', size(red_onsets, 2)), 'Location', 'northeast', 'FontSize', 14, 'Interpreter', 'none');
                end    
                if strcmp(Stimulus_type, 'E_CD')
                    legend(sprintf('ABCD (%dx)', size(blue_onsets, 2)), sprintf('%s (%dx)', Stimulus_type, size(red_onsets, 2)), 'Location', 'northeast', 'FontSize', 14, 'Interpreter', 'none');              
                end          
        ...
        if strcmp(Stimulus_type, 'DCBA') && contains(plot_choice, 'aggregate') && contains(plot_type, 'FR')
            for nprobe = 1:length(clusters)
                ...
                xline(0, 'k', (sprintf('A %d%s or D onset', normal_sequence(1), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'FontSize', 14);
                xline(0.30, 'k', (sprintf('B %d%s or C onset', normal_sequence(2), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'FontSize', 14);
                xline(0.60, 'k', (sprintf('C %d%s or B onset', normal_sequence(3), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'FontSize', 14);
                xline(0.90, 'k', (sprintf('D %d%s or A onset', normal_sequence(4), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'FontSize', 14);
                ...
                sgtitle(sprintf('%s - %s - aggregate single unit activity, %s depth range %d–%d μm', subject_number, Stimulus_type, depth_for_analysis, min(depth_range), max(depth_range)), 'Interpreter', 'none', 'FontSize', 14);
        ...
        if (contains(Stimulus_type, 'GAVNIK_ABCD') || contains(Stimulus_type, 'GAVNIK DCBA')) && contains(plot_choice, 'aggregate') && contains(plot_type, 'FR')
            for nprobe = 1:length(clusters)
                ...
                set(gca, "TickDir", "out", 'Color', 'none', 'FontSize', 12);
                ...
                for nCluster = 1:length(cluster_id) % loop through each good cluster at selected depth
                    ...
                    for ori = 1 % plot from onset of first stimulus in sequence 
                        ...
                        if contains(plot_type, 'raster')
                            ...
                            sgtitle(sprintf('%s %s cluster %d rasters %s', subject_number, depth_for_analysis, cluster_id, Stimulus_type, 'Interpreter', 'none', 'FontSize', 16));
                            set(gca,"TickDir","out", 'Color','none','FontSize',14)
                        end
        ...
        if (contains(Stimulus_type, 'GAVNIK_A_CD') || contains(Stimulus_type, 'GAVNIK_E_CD')) && contains(plot_choice, 'aggregate') && contains(plot_type, 'FR')
            for nprobe = 1:length(clusters)
                ...
                xline(0, 'k', (sprintf('A %d%s onset', round(ordered_oris(1)), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'HandleVisibility', 'off', 'FontSize', 14);
                xline(0.15, 'k', (sprintf('grey onset')), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'HandleVisibility', 'off', 'FontSize', 14);
                xline(0.30, 'k', (sprintf('C %d%s onset', round(ordered_oris(3)), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'HandleVisibility', 'off', 'FontSize', 14);
                xline(0.45, 'k', (sprintf('D %d%s onset', round(ordered_oris(4)), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'HandleVisibility', 'off', 'FontSize', 14);
