...
plot_ipsi_contra_MUA_synchronisation_detection_thresholded % Normalised duration (not in use)
plot_ipsi_contra_MUA_synchronisation_detection_thresholded_norm % Normalised duration (not in use)

plot_ipsi_contra_UP_DOWN_ripples_coupling_detection_thres_norm
