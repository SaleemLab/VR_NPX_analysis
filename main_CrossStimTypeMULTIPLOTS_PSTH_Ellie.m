...
sessions_to_plot = [11, 15]; %4/5 row numbers of recording dates in "experiment_info" 11, 12, 13, 14, 15
colors = [
...
for nsession = sessions_to_plot 
    ...
    for n = 1:length(session_info) 
        ...
        if contains(Stimulus_type, 'TRAIN') && contains(plot_choice, 'aggregate') && contains(plot_type, 'FR')        
            ...
            xline(0, 'k', (sprintf('A onset %d%s onset', round(rad2deg(ordered_oris(1))), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'HandleVisibility', 'off');
            xline(0.30, 'k', (sprintf('B %d%s onset', round(rad2deg(ordered_oris(2))), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'HandleVisibility', 'off');
            xline(0.60, 'k', (sprintf('C %d%s onset', round(rad2deg(ordered_oris(3))), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'HandleVisibility', 'off');
            xline(0.90, 'k', (sprintf('D %d%s onset', round(rad2deg(ordered_oris(4))), char(176))), 'LabelVerticalAlignment','top', 'LabelHorizontalAlignment', 'left', 'HandleVisibility', 'off');
            ...
            % Also save as .fig
            fig_filename = sprintf('%s - %s - Multiplot L4 FRs across %d days.fig', subject_number, Stimulus_type, length(sessions_to_plot));
