...
for nsession = 10
    ...
    for n = 1:length(session_info) % How many recording sessions for spatial tasks (PRE, RUN and POST)
        ...
        for nprobe = 1:length(clusters)
            ...
            [TPP, ~]= phase_precession_absolute_location(LFP(nprobe).tvec,CA1_LFP,place_fields,selected_clusters,Task_info,Behaviour,options);
            
            control_plots_phase_precession(LFP(nprobe).tvec,CA1_LFP,place_fields,selected_clusters,TPP,Task_info,Behaviour,options)
