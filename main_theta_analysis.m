...
for nsession = [1 2 3 4 6 7 8 9 10 12 14]
    ...
    for n = 1:length(session_info) % How many recording sessions for spatial tasks (PRE, RUN and POST)
        ...
        plot_theta_modulation(selected_clusters,place_fields,theta_modulation_L,theta_modulation_R,session_info(n).probe);
...
%% Plotting all sessions combined theta modulation
