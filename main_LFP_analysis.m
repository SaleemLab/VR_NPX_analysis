...
%             merged_clusters.region
            ...
            [replay(probe_no),reactivations(probe_no)] = detect_candidate_events_masa(LFP(nprobe).tvec,CA1_LFP,...
                [CA1_clusters(nprobe).merged_spike_id CA1_clusters(nprobe).spike_times],Behaviour,zscore_min,zscore_max,options);
            ...
            [V1_replay(probe_no),V1_reactivations(probe_no)] = detect_candidate_events_masa(LFP(nprobe).tvec,CA1_LFP,...
                [V1_clusters(nprobe).merged_spike_id V1_clusters(nprobe).spike_times],Behaviour,zscore_min,zscore_max,options);
