function estimated_position = log_odds_bayesian_decoding(place_fields_BAYESIAN,bayesian_spike_count,place_field_index,timebin,posbin,option,modify,save_option)
% INPUTS:
