...
% 
function SGLXMetaToCoords_ChannelMap_EHversion(metaName,saveName)
...
switch outType
    ...
    case 1     %KS2 *.mat
        ...
        save( fullfile(saveName, newName), 'chanMap', 'chanMap0ind', 'connected', 'name', 'xcoords', 'ycoords', 'kcoords' );
