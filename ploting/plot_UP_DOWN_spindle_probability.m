...
load(fullfile(analysis_folder,'V1-HPC sleep interaction','SO_spindles_probability_normalised_whole.mat'));
probability_spindles_normalised_whole = probability_normalised;
load(fullfile(analysis_folder,'V1-HPC sleep interaction','SO_spindles_probability_normalised_whole_baseline.mat'));
probability_spindles_normalised_whole_baseline = probability_normalised;

load(fullfile(analysis_folder,'V1-HPC sleep interaction','SO_spindles_probability_whole.mat'));
probability_spindles_psth_whole = probability;
load(fullfile(analysis_folder,'V1-HPC sleep interaction','SO_spindles_probability_whole_baseline.mat'));
probability_spindles_psth_whole_baseline = probability;

load(fullfile(analysis_folder,'V1-HPC sleep interaction','SO_spindles_probability_normalised.mat'));
probability_spindles_normalised = probability_normalised;
load(fullfile(analysis_folder,'V1-HPC sleep interaction','SO_spindles_probability_normalised_baseline.mat'));
probability_spindles_normalised_baseline = probability_normalised;

load(fullfile(analysis_folder,'V1-HPC sleep interaction','SO_spindles_probability.mat'));
probability_spindles_psth = probability;
load(fullfile(analysis_folder,'V1-HPC sleep interaction','SO_spindles_probability_baseline.mat'));
probability_spindles_psth_baseline = probability;
...
probe_hemisphere_texts = {'Probability of spindles during left V1 normalised UP-DOWN duration','Probability of spindles during right V1 normalised UP-DOWN duration'};
...
for nprobe = 1:2
    ...
    %%%% Left spindles plotting
    %%%% DOWN
    nexttile
    x = linspace(0,1,num_bins);
    y = cumsum(sum(probability(nprobe).L_spindles_DOWN)./all_DOWN_no);
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(cumsum(probability(nprobe).L_spindles_DOWN_bootstrap,2),2.5);
    UCI = prctile(cumsum(probability(nprobe).L_spindles_DOWN_bootstrap,2),97.5);
    ...
    nexttile
    x = linspace(0,1,num_bins);
    y = sum(probability(nprobe).L_spindles_DOWN)./all_DOWN_no;
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(probability(nprobe).L_spindles_DOWN_bootstrap,2.5);
    UCI = prctile(probability(nprobe).L_spindles_DOWN_bootstrap,97.5);
    ...
    % xline(0,'r')
    title('Probability of left spindles during DOWN')
    xlabel('Normalised duration of DOWN')
    ylabel('Probability')
    set(gca,"TickDir","out",'box', 'off','Color','none','FontSize',12)
    ...
    nexttile
    x = linspace(0,1,num_bins);
    y = cumsum(sum(probability(nprobe).L_spindles_UP)./all_UP_no);
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(cumsum(probability(nprobe).L_spindles_UP_bootstrap,2),2.5);
    UCI = prctile(cumsum(probability(nprobe).L_spindles_UP_bootstrap,2),97.5);
    ...
    nexttile
    x = linspace(0,1,num_bins);
    y = sum(probability(nprobe).L_spindles_UP)./all_UP_no;
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(probability(nprobe).L_spindles_UP_bootstrap,2.5);
    UCI = prctile(probability(nprobe).L_spindles_UP_bootstrap,97.5);
    ...
    % legend(ERROR_SHADE(1:2),{'Original','Shuffled'},'Box','off')
    % xline(0,'r')
    title('Probability of left spindles during UP')
    xlabel('Normalised duration of UP')
    ylabel('Probability')
    set(gca,"TickDir","out",'box', 'off','Color','none','FontSize',12)
    ...
    %%%% right spindles plotting
    %%%% DOWN
    nexttile
    x = linspace(0,1,num_bins);
    y = cumsum(sum(probability(nprobe).R_spindles_DOWN)./all_DOWN_no);
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(cumsum(probability(nprobe).R_spindles_DOWN_bootstrap,2),2.5);
    UCI = prctile(cumsum(probability(nprobe).R_spindles_DOWN_bootstrap,2),97.5);
    ...
    nexttile
    x = linspace(0,1,num_bins);
    y = sum(probability(nprobe).R_spindles_DOWN)./all_DOWN_no;
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(probability(nprobe).R_spindles_DOWN_bootstrap,2.5);
    UCI = prctile(probability(nprobe).R_spindles_DOWN_bootstrap,97.5);
    ...
    % legend(ERROR_SHADE(1:2),{'Original','Shuffled'},'Box','off')
    % xline(0,'r')
    title('Probability of right spindles during DOWN')
    xlabel('Normalised duration of DOWN')
    ylabel('Probability')
    set(gca,"TickDir","out",'box', 'off','Color','none','FontSize',12)
    ...
    nexttile
    x = linspace(0,1,num_bins);
    y = cumsum(sum(probability(nprobe).R_spindles_UP)./all_UP_no);
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(cumsum(probability(nprobe).R_spindles_UP_bootstrap,2),2.5);
    UCI = prctile(cumsum(probability(nprobe).R_spindles_UP_bootstrap,2),97.5);
    ...
    nexttile
    x = linspace(0,1,num_bins);
    y = sum(probability(nprobe).R_spindles_UP)./all_UP_no;
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(probability(nprobe).R_spindles_UP_bootstrap,2.5);
    UCI = prctile(probability(nprobe).R_spindles_UP_bootstrap,97.5);
    ...
    % legend(ERROR_SHADE(1:2),{'Original','Shuffled'},'Box','off')
    % xline(0,'r')
    title('Probability of right spindles during UP')
    xlabel('Normalised duration of UP')
    ylabel('Probability')
    set(gca,"TickDir","out",'box', 'off','Color','none','FontSize',12)
end
...
colour_lines = [215,25,28;44,123,182]/256;
probe_hemisphere_texts = {'Probability of spindles during left V1 UP-DOWN','Probability of spindles during right V1 UP-DOWN'};
...
% all_sessions = max(slow_waves_all(1).DOWN_session_count);
colour_lines = [215,25,28;253,174,97;171,217,233;44,123,182]/256;
probe_hemisphere_texts = {'Probability of WHOLE spindles during left V1 normalised UP-DOWN duration','Probability of WHOLE spindles during right V1 normalised UP-DOWN duration'};
% probe_hemisphere_texts = {'Probability of WHOLE ripples during left V1 normalised UP-DOWN duration','Probability of WHOLE ripples during right V1 normalised UP-DOWN duration'};
...
colour_lines = [215,25,28;44,123,182]/256;
probe_hemisphere_texts = {'Probability of WHOLE spindles during left V1 UP-DOWN','Probability of WHOLE spindles during right V1 UP-DOWN'};
% probe_hemisphere_texts = {'Probability of WHOLE ripples during left V1 UP-DOWN','Probability of WHOLE ripples during right V1 UP-DOWN'};
colour_lines = [215,25,28;44,123,182]/256;
for nprobe = 1:2
    fig(nprobe)=figure;
...
%% Plotting distribution of ripple + spindles during normalised duration of UP  (peaktimes)
probability = probability_normalised;
probability_spindles = probability_spindles_normalised;
...
probe_hemisphere_texts = {'Probability of ripples and spindles during left V1 normalised UP-DOWN duration','Probability of ripples and spindles during right V1 normalised UP-DOWN duration'};
...
for nprobe = 1:2
    ...
    y = cumsum(sum(probability_spindles(nprobe).L_spindles_DOWN)./all_DOWN_no);
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(cumsum(probability_spindles(nprobe).L_spindles_DOWN_bootstrap,2),2.5);
    UCI = prctile(cumsum(probability_spindles(nprobe).L_spindles_DOWN_bootstrap,2),97.5);
    ...
    legend(ERROR_SHADE(1:2),{'Ripples','Spindles'},'Location','northwest','Box','off')
    ...
    y = sum(probability_spindles(nprobe).L_spindles_DOWN)./all_DOWN_no;
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(probability_spindles(nprobe).L_spindles_DOWN_bootstrap,2.5);
    UCI = prctile(probability_spindles(nprobe).L_spindles_DOWN_bootstrap,97.5);
    ...
    % legend(ERROR_SHADE(1:2),{'Original','Shuffled'},'Box','off')
    % xline(0,'r')
    title('Probability of left ripples/spindles during DOWN')
    xlabel('Normalised duration of DOWN')
    ylabel('Probability')
    set(gca,"TickDir","out",'box', 'off','Color','none','FontSize',12)
    ...
    y = cumsum(sum(probability_spindles(nprobe).L_spindles_UP)./all_UP_no);
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(cumsum(probability_spindles(nprobe).L_spindles_UP_bootstrap,2),2.5);
    UCI = prctile(cumsum(probability_spindles(nprobe).L_spindles_UP_bootstrap,2),97.5);
    ...
    y = sum(probability_spindles(nprobe).L_spindles_UP)./all_UP_no;
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(probability_spindles(nprobe).L_spindles_UP_bootstrap,2.5);
    UCI = prctile(probability_spindles(nprobe).L_spindles_UP_bootstrap,97.5);

    PLOT = plot(x,y,'Color',colour_lines(nprobe+2,:));hold on;
    ERROR_SHADE(2) = patch([x fliplr(x)],[UCI fliplr(LCI)],colour_lines(nprobe+2,:),'FaceAlpha','0.3','LineStyle','none');
    % legend(ERROR_SHADE(1:2),{'Original','Shuffled'},'Box','off')
    % xline(0,'r')
    title('Probability of left ripples/spindles during UP')
    xlabel('Normalised duration of UP')
    ylabel('Probability')
    set(gca,"TickDir","out",'box', 'off','Color','none','FontSize',12)
    ...
    y = cumsum(sum(probability_spindles(nprobe).R_spindles_DOWN)./all_DOWN_no);
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(cumsum(probability_spindles(nprobe).R_spindles_DOWN_bootstrap,2),2.5);
    UCI = prctile(cumsum(probability_spindles(nprobe).R_spindles_DOWN_bootstrap,2),97.5);
    ...
    y = sum(probability_spindles(nprobe).R_spindles_DOWN)./all_DOWN_no;
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(probability_spindles(nprobe).R_spindles_DOWN_bootstrap,2.5);
    UCI = prctile(probability_spindles(nprobe).R_spindles_DOWN_bootstrap,97.5);
    ...
    % legend(ERROR_SHADE(1:2),{'Original','Shuffled'},'Box','off')
    % xline(0,'r')
    title('Probability of right ripples/spindles during DOWN')
    xlabel('Normalised duration of DOWN')
    ylabel('Probability')
    set(gca,"TickDir","out",'box', 'off','Color','none','FontSize',12)
    ...
    y = cumsum(sum(probability_spindles(nprobe).R_spindles_UP)./all_UP_no);
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(cumsum(probability_spindles(nprobe).R_spindles_UP_bootstrap,2),2.5);
    UCI = prctile(cumsum(probability_spindles(nprobe).R_spindles_UP_bootstrap,2),97.5);
    ...
    y = sum(probability_spindles(nprobe).R_spindles_UP)./all_UP_no;
    %     y = mean(cumsum(probability(nprobe).L_ripples_DOWN_bootstrap,2));
    LCI = prctile(probability_spindles(nprobe).R_spindles_UP_bootstrap,2.5);
    UCI = prctile(probability_spindles(nprobe).R_spindles_UP_bootstrap,97.5);

    PLOT = plot(x,y,'Color',colour_lines(nprobe+2,:));hold on;
    ERROR_SHADE(2) = patch([x fliplr(x)],[UCI fliplr(LCI)],colour_lines(nprobe+2,:),'FaceAlpha','0.3','LineStyle','none');
    % legend(ERROR_SHADE(1:2),{'Original','Shuffled'},'Box','off')
    % xline(0,'r')
    title('Probability of right ripples/spindles during UP')
    xlabel('Normalised duration of UP')
    ylabel('Probability')
    set(gca,"TickDir","out",'box', 'off','Color','none','FontSize',12)
end
...
%% plotting Probability of SWR + spindles relative to UP and DOWN onset (peaktimes)
probability = probability_psth;
probability_spindles= probability_spindles_psth;
...
probe_hemisphere_texts = {'Probability of ripples and spindles during left V1 UP-DOWN','Probability of ripples and spindles during right V1 UP-DOWN'};
% probe_hemisphere_texts = {'Probability of WHOLE ripples during left V1 UP-DOWN','Probability of WHOLE ripples during right V1 UP-DOWN'};
...
%% Plotting distribution of ripple + spindle during normalised duration of UP  (WHOLE)
probability = probability_normalised_whole;
probability_spindles = probability_spindles_normalised_whole;
...
% colour_lines = [215,25,28;253,174,97;171,217,233;44,123,182]/256;
% probe_hemisphere_texts = {'Probability of ripples during left V1 normalised UP-DOWN duration','Probability of ripples during right V1 normalised UP-DOWN duration'};
probe_hemisphere_texts = {'Probability of WHOLE ripples and spindles during left V1 normalised UP-DOWN duration','Probability of WHOLE ripples and spindles during right V1 normalised UP-DOWN duration'};
% colour_lines = [215,48,39;69,117,180;244,109,67;145,191,219]/256;% 4 colors Dark red, orangish red, light blue, dark blue
% colour_lines = [215,25,28;253,174,97;171,217,233;44,123,182]/256;
colour_lines = [215,48,39;69,117,180;244,109,67;145,191,219]/256;% 4 colors Dark red, orangish red, light blue, dark blue
...
%% plotting Probability of SWR + spindles relative to UP and DOWN onset (WHOLE)
probability = probability_psth_whole;
probability_spindles= probability_spindles_psth_whole;
...
probe_hemisphere_texts = {'Probability of WHOLE ripples and spindles during left V1 UP-DOWN','Probability of WHOLE ripples and spindles during right V1 UP-DOWN'};
% probe_hemisphere_texts = {'Probability of WHOLE ripples during left V1 UP-DOWN','Probability of WHOLE ripples during right V1 UP-DOWN'};
...
%% Plotting distribution of spindles during normalised duration of UP  (WHOLE)
probability = probability_normalised_whole;
probability_spindles = probability_spindles_normalised_whole;
