...
%% Ipsi and contra spindles probabilities during DOWN UP with different bilateral synchrony
...
index = [];
%%%%% UP info
UP_index_all = [probability(1).UP_all_index; probability(2).UP_all_index];
DOWN_index_all = [probability(1).DOWN_all_index; probability(2).DOWN_all_index];
...
%%%%%%%%%%%%%%%%%%%%%
ipsi_probability = [probability_psth_whole(1).L_spindles_UP; probability_psth_whole(2).R_spindles_UP];
contra_probability = [probability_psth_whole(1).R_spindles_UP; probability_psth_whole(2).L_spindles_UP];
...
probability_merged.spindles_UP_groups = [title_names 'All DOWN-UP'];
...
%%%%%%%%%%%%
%%%%%%%%%%%% All DOWN UP rpples
event_averaging_scale = 20;

% for ngroup = 1:length(event_idx)
ngroup = 2;
fig = figure('Color','w');
fig.Position = [350 59 1650 465];
fig.Name = 'Left-Right combined ipsi contra spindle distribution around DOWN-UP transition'
...
%%%%%%%%%%%%%%%%%%%%%
ipsi_probability = [probability_psth_whole(1).L_spindles_DOWN; probability_psth_whole(2).R_spindles_DOWN];
contra_probability = [probability_psth_whole(1).R_spindles_DOWN; probability_psth_whole(2).L_spindles_DOWN];
...
probability_merged.spindles_DOWN_groups = [title_names 'All UP-DOWN’'];
...
fig = figure('Color','w');
fig.Position = [350 59 1650 465];
fig.Name = 'Left-Right combined ipsi contra spindles distribution around UP-DOWN transition'
