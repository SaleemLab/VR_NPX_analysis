function output = predict_HPC_MUA_by_DOWN_UP_synchrony(ipsi_V1_MUA, contra_V1_MUA, ipsi_HPC_MUA, contra_HPC_MUA, DOWN_UP_lag,varargin)
...
if isempty(output)
    ...
    lag_thresholds = prctile(DOWN_UP_lag,[0:1/4*100:100]);
    %     lag_thresholds = 0:0.025:0.15;
