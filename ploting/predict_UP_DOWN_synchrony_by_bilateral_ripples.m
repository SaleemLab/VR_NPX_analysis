function output = predict_UP_DOWN_synchrony_by_bilateral_ripples(ipsi_V1_MUA,contra_V1_MUA,ipsi_HPC_MUA,ipsi_ripples,UP_DOWN_info,varargin)
...
if isempty(output)
    ...
    parfor iBoot = 1:nBoot
        ...
        % Filtered table: Removed contra ripple/HPC, kept contra Delta/V1/Spindle
        tbl = table(normalize(ipsi_ripple_duration(index)), ...
            ...
            'downDuration', 'ipsiSpindle', 'contraSpindle', 'UP_DOWN_lag', ...
            'subjectID', 'sessionID'});
