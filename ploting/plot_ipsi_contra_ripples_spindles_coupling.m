...
load(fullfile(analysis_folder,'V1-HPC sleep interaction','spindles_ripples_probability.mat'),'probability');
...
%%%%%%%%%%%%%%%%%%%%%
ipsi_probability = [probability_psth_whole(1).L_ripple; probability_psth_whole(2).R_ripple];
contra_probability = [probability_psth_whole(1).R_ripple; probability_psth_whole(2).L_ripple];

ipsi_probability_baseline = [probability_psth_whole_baseline(1).L_ripple; probability_psth_whole_baseline(2).R_ripple];
...
probability_merged.ipsi_ripples_spindles = [];
