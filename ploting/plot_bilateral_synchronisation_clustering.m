...
for nprobe = 1:2
    ...
    lag_index{nprobe} = zeros(1,length(event_info(nprobe).UP_lag_diff));
    lag_index{nprobe}(event_info(nprobe).UP_lag_diff< event_info(nprobe).UP_lag_threshold_low) = -1;
    lag_index{nprobe}(event_info(nprobe).UP_lag_diff> event_info(nprobe).UP_lag_threshold_high) = 1;
end
