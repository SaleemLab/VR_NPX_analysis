function output = predict_bilateral_ripples_by_DOWN_UP(ipsi_V1_MUA,contra_V1_MUA,ipsi_HPC_MUA,ipsi_ripples,UP_DOWN_info,varargin)
% SETTINGS
p = inputParser;
...
DOWN_UP_index = 1:length(ipsiV1_cat);
...
if isempty(output)
    ...
    parfor iBoot = 1:nBoot
        ...
        output(iBoot).type = repmat({'All'}, nModels, 1);
        toc
    end
