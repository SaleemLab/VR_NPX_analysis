...
title_names{4} = 'Ipsi-contra UP_DOWN ripple probability by 5 powers (150ms windows)';
title_names{5} = 'Ipsi-contra UP_DOWN ripple probability by 5 powers (All events)';
