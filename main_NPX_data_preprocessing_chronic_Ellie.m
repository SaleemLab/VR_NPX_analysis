...
%% Run this code section-by-section (evaluate selection in command window)
...
for n = 1:length(all_SUBJECTS)
    ...
    experiment_info = subject_session_stimuli_mapping_Ellie(SUBJECTS,'V1-HPC');

    stimuli_info = readtable('V:\Ellie\DATA\Ellie_session_stimuli_table','Sheet',all_SUBJECTS{n});
...
%             end
    ...
    % writetable(stimuli_info,'V:\Ellie\DATA\Ellie_session_stimuli_table.xlsx','Sheet',all_SUBJECTS{n});
...
%All_stimuli = {'TRAIN', 'OP_Tuning', 'Direction_Tuning', 'DCBA', 'OMIT', 'E_CD', 'ADCD', 'lowcontB', 'lowcontDsubbingB', 'lowcontTRAIN'}
All_stimuli = {'DCBA', 'OMIT', 'E_CD', 'ADCD', 'lowcontB', 'lowcontDsubbingB', 'lowcontTRAIN'}
...
SUBJECTS = {'M24016'};
SUBJECTS = {'M24065'};
experiment_info = subject_session_stimuli_mapping_Ellie(SUBJECTS,'bilateral');
