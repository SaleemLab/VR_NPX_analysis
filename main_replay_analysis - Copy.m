        ...
        for mprobe = 1:length(V1_place_fields.probe)
            ...
            if ~isempty(V1_cell_spike_count_L)
                ...
                for ncell = 1:size(V1_cell_spike_count_L,2)
                    ...
                    V1_all_cells{nsession}{1}(cell_index_L(ncell))
                ...
                sgtitle(sprintf('Left V1 SUA %s SWR activity %s %s',ripple_probe_text{ripple_probe_hemisphere},session_info(n).probe(1).SUBJECT,session_info(n).probe(1).SESSION))
