function dataStruct = alignquad2photodiode(MousePos,photodiode,plotFlag)
...
threshold = prctile(photodiode.signal,95); % For now arbitary threshold (50%);
signal = zeros(1,length(photodiode.signal));
signal(photodiode.signal>threshold) = 1;
