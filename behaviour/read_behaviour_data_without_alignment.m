function   [behaviour] = read_behaviour_data_without_alignment(path,date)
...
if ~isempty(wheel_log_path)
    ...
    behaviour.wheel_position = cellfun(@(x) x(11:end), behaviour.wheel_position, 'UniformOutput',false);
