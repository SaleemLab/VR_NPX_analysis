    ...
    for n = 1:length(session_info) % How many recording sessions for spatial tasks (PRE, RUN and POST)
        ...
        for nprobe = 1:length(clusters)
            ...
            if options.probe_hemisphere == 1
                [ripple_modulation_L]= ripple_modulation_analysis(clusters_combined.spike_times,clusters_combined.merged_spike_id,Task_info,Behaviour,[-1 1],0.02,...
            ...
            elseif options.probe_hemisphere == 2
                [ripple_modulation_R]= ripple_modulation_analysis(clusters_combined.spike_times,clusters_combined.merged_spike_id,Task_info,Behaviour,[-1 1],0.02,...
                'unit_depth',clusters_combined.peak_depth(ia),'unit_region',clusters_combined.region(ia),'unit_id',C,'event_times',event_times',...
                'event_label',{'Track 1','Track 2'},'event_id',event_id(index)','place_fields',place_fields);
