...
cairo_pdf("LastRippleNextUP_Model_Effect_Sizes_With_CI.pdf", width = 10, height = 6.5)
print(p_bars_with_ci)
dev.off()
...
write.csv(combined_results, "LastRippleNextUP_GAM_model_CI_output.csv", row.names = FALSE)
message("\nAnalysis Pipeline Complete! Saved 'LastRippleNextUP_GAM_model_CI_output.csv' and figures.")
