function [freezing,quietWake,SWS,REM,movement] = detect_behavioural_states_bilateral(corticalLFP,hpcLFP,speed,speedTreshold,varargin)
...
spindleLFP = [corticalLFP(:,1) filtfilt(b_spindle,1,corticalLFP(:,2))];
